...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"insert into tblfoodtracking(OrderId,remark,status,OrderCanclledByUser) value('$oid','$remark','$canclbyuser')"); 
   $query=mysqli_query($con, "update   orderaddresses set OrderFinalStatus='$ressta' where Ordernumber='$oid'");
    if ($query) {
