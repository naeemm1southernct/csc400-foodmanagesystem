...
?>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            <h5><a href="food-detail.php?editid=<?php echo $row['ID'];?>"><?php echo $row['ItemName'];?></a></h5>
                                            <div class="product-name"><?php echo substr($row['ItemDes'],0,50);?></div>
                                            <div class="price-btn-block"> <span class="price">$ <?php echo $row['ItemPrice'];?></span> <a href="profile.html" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                        </div>
